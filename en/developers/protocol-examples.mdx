...
1. Resolve the token's `poolId`.
2. Resolve or build the token's `PoolKey`.
3. Quote through the Hook.
4. Execute buys and sells through the Swap Router.
5. Execute borrow, borrow more, and repay through the Hook.
